...
## [0.4.0](https://github.com/rocketxujia/metamask-institutional/compare/extension-v0.3.25...extension-v0.4.0) (2024-07-12)
...
* The following workspace dependencies were updated
  * dependencies
    * @mm-institutional/custody-controller bumped from ^0.3.4 to ^0.3.0
    * @mm-institutional/custody-keyring bumped from ^3.0.4 to ^3.0.0
    * @mm-institutional/portfolio-dashboard bumped from ^1.4.2 to ^1.5.0
