...
## [0.4.0](https://github.com/rocketxujia/metamask-institutional/compare/extension-v0.3.21...extension-v0.4.0) (2024-05-22)
...
* The following workspace dependencies were updated
  * dependencies
    * @metamask-institutional/custody-controller bumped from ^0.2.25 to ^0.3.0
    * @metamask-institutional/custody-keyring bumped from ^1.1.0 to ^2.0.0
    * @metamask-institutional/portfolio-dashboard bumped from ^1.4.0 to ^1.5.0
    * @metamask-institutional/sdk bumped from ^0.1.26 to ^0.1.27
    * @metamask-institutional/transaction-update bumped from ^0.2.0 to ^0.3.0
