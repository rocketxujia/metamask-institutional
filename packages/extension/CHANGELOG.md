...
* The following workspace dependencies were updated
  * dependencies
    * @mm-institutional/portfolio-dashboard bumped from ^1.4.0 to ^1.4.1

### Dependencies

* The following workspace dependencies were updated
  * dependencies
    * @mm-institutional/custody-controller bumped from ^0.2.25 to ^0.2.26
    * @mm-institutional/custody-keyring bumped from ^1.1.0 to ^1.1.1
    * @mm-institutional/sdk bumped from ^0.1.26 to ^0.1.27
    * @mm-institutional/transaction-update bumped from ^0.2.0 to ^0.2.1

### Dependencies

* The following workspace dependencies were updated
  * dependencies
    * @mm-institutional/custody-controller bumped from ^0.2.26 to ^0.2.27
    * @mm-institutional/custody-keyring bumped from ^1.1.2 to ^2.0.0
    * @mm-institutional/transaction-update bumped from ^0.2.1 to ^0.2.2

### Dependencies

* The following workspace dependencies were updated
  * dependencies
    * @mm-institutional/custody-controller bumped from ^0.2.27 to ^0.2.28
...
## [0.4.0](https://github.com/rocketxujia/metamask-institutional/compare/extension-v0.3.25...extension-v0.4.0) (2024-07-08)
...
* The following workspace dependencies were updated
  * dependencies
    * @mm-institutional/custody-controller bumped from ^0.2.28 to ^0.3.0
    * @mm-institutional/custody-keyring bumped from ^2.0.1 to ^3.0.0
    * @mm-institutional/portfolio-dashboard bumped from ^1.4.1 to ^1.5.0
    * @mm-institutional/sdk bumped from ^0.1.27 to ^0.2.0
    * @mm-institutional/transaction-update bumped from ^0.2.3 to ^0.3.0
