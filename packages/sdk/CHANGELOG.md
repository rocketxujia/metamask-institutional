...
## [0.2.1](https://github.com/rocketxujia/metamask-institutional/compare/sdk-v0.2.0...sdk-v0.2.1) (2024-07-08)


### Bug Fixes

* **sdk:** modify jsonportalclient and jsonportalcustodianapi ([2b76e12](https://github.com/rocketxujia/metamask-institutional/commit/2b76e120758830c978f0363160f93ae1ee8aaa59))
...
* **content-type:** setting content-type as json ([#494](https://github.com/rocketxujia/metamask-institutional/issues/494)) ([c1afa70](https://github.com/rocketxujia/metamask-institutional/commit/c1afa70c366576952b997ad025a46a77b5affdeb))
* **errormessage:** if the server responds with a 401 status code when trying to get the access token ([#534](https://github.com/rocketxujia/metamask-institutional/issues/534)) ([593b2a2](https://github.com/rocketxujia/metamask-institutional/commit/593b2a228364deaac657435a3fcf840bb6f9e84f))
* **fetchapi:** error handling with fetch api ([#500](https://github.com/rocketxujia/metamask-institutional/issues/500)) ([cf64009](https://github.com/rocketxujia/metamask-institutional/commit/cf6400906b1b34b1120370b0624448ade71cedb0))
...
* only create an ITR event if the custodian returns a URL where the user can go ([#608](https://github.com/rocketxujia/metamask-institutional/issues/608)) ([dc17ed2](https://github.com/rocketxujia/metamask-institutional/commit/dc17ed2e60b8cf44d3b3d49e5ccac5c7e9e51959))
* **refresh-token:** logic around refresh token ([#682](https://github.com/rocketxujia/metamask-institutional/issues/682)) ([14b771c](https://github.com/rocketxujia/metamask-institutional/commit/14b771c1f5d1a613ead9fd568cae8e0cba8b9464))
* **response:** response result ([#543](https://github.com/rocketxujia/metamask-institutional/issues/543)) ([d649bd3](https://github.com/rocketxujia/metamask-institutional/commit/d649bd32476507c3d68a4c777d51f2c4f7a5acb7))
* **sdk:** bump version ([#721](https://github.com/rocketxujia/metamask-institutional/issues/721)) ([a965fe4](https://github.com/rocketxujia/metamask-institutional/commit/a965fe4732d07bfeb72dfa9ba4ceb132b23261d2))
* **sdk:** fetch is not working as axios so we moved our logic outside catch ([#140](https://github.com/rocketxujia/metamask-institutional/issues/140)) ([b9391aa](https://github.com/rocketxujia/metamask-institutional/commit/b9391aa2ea24b9e80b2e555253b165ad60f468d4))
...
* The following workspace dependencies were updated
  * dependencies
    * @mm-institutional/simplecache bumped from ^1.1.0 to ^1.2.0
