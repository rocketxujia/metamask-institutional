...
export class JupiterCustodianApi extends EventEmitter implements ICustodianApi {
  ...
  async getEthereumAccounts(): Promise<IEthereumAccount<IJupiterEthereumAccountCustodianDetails>[]> {
  ...
  async createTransaction(
    ...
    const result = await this.client.createTransaction({ accountId, chainId: txMeta.chainId }, txParams);
  ...
  async signTypedData_v4(
    ...
    const result = await this.client.signTypedData_v4(accountId, message, version);
