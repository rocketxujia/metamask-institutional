...
## [0.4.0](https://github.com/rocketxujia/metamask-institutional/compare/transaction-update-v0.3.0...transaction-update-v0.4.0) (2024-06-05)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @mm-institutional/websocket-client bumped from ^0.2.3 to ^0.3.0
